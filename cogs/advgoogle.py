...
class AdvancedGoogle:
    ...
    async def _advgoogle(self, ctx, text):
        ...
        if search_type[0] == "image" or search_type[0] == "images":
            if search_valid == "image" or search_valid == "images":
                await self.bot.say("SVP donnez des termes à rechercher...")
            else:
                ...
                if url and not error:
                    ...
                    await self.bot.say("Votre recherche n'a retourné aucun résultat ! :confused:")
            # End of Image
        # Start of Maps
            ...
            if search_valid == "maps":
                ...
                uri = "https://www.google.fr/maps/search/"
        ...
        # Start of generic search
            ...
            uri = "https://www.google.fr/search?hl=en&q="
            quary = str(ctx.message.content
    ...
    async def images(self, ctx, regex, option, images: bool=False):
        uri = "https://www.google.fr/search?hl=en&tbm=isch&tbs=isz:m&q="
        num = 7
        if images:
            num = 8
        quary = str(ctx.message.content
    ...
    def parsed(self, find, regex, found: bool=True):
        ...
        for i in range(len(find)):
            if i == 0:
                find[i] = find[i] + "\n\n**Voici les autres résultats pertinents de la recheche:**"
            else:
